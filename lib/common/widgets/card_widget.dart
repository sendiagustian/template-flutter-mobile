      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: noImage
                ? titlePadding ?? AppTheme.geometry.medium
                : AppTheme.geometry.custom(left: 16, top: 16, right: 16, bottom: withSeparator ? 12 : 0),
            child: Builder(builder: (context) {
              if (titleAlignment == TextAlign.center) {
                return Center(
                  child: Text(title, textAlign: titleAlignment, style: titleTextStyle ?? AppTheme.typography.titleMedium),
                );
              } else {
                return Text(title, textAlign: titleAlignment, style: titleTextStyle ?? AppTheme.typography.titleMedium);
              }
            }),
          ),
  ...
  static Widget expansion({
    ...
    return Container(
      ...
      child: ExpansionTile(
        ...
        tilePadding: titlePadding ?? AppTheme.geometry.custom(left: 16, right: 16, top: 8, bottom: 8),
        title: Text(title, textAlign: titleAlignment, style: titleTextStyle ?? AppTheme.typography.titleMedium),
